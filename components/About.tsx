...
const About = () => {
  ...
  const expertise = [
    ...
    },
    {
      ...
      description: "RESTful APIs, GraphQL, and real-time communication",
  ...
  const stats = [
    ...
    { label: "Projects Delivered", value: "15+", color: "text-green-500" },
    { label: "APIs Built", value: "50+", color: "text-purple-500" },
    { label: "Systems Scaled", value: "10+", color: "text-orange-500" },
  ]
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4 code-gradient">Backend Engineer & System Architect</h2>
